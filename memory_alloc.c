...
// allocation and management. These functions can be found in the <stdlib.h> header
// file.

/*
void *calloc(int num, int size); //This function allocates an array of # elements each of size in bytes will be size.
